...
REPO_ROOT="/home/rvalper/supernode-tokenizer"
. "$REPO_ROOT/experiments/env_ivi.sh"
...
if not torch.cuda.is_available():
    raise SystemExit(
        ...
        "Activate the correct Python environment before submission or export "
        "SUPERNODE_TOKENIZER_CONDA_PREFIX in the submission shell."
    )
PY
