...
def get_config() -> ConfigDict:
    ...
    cfg.model.diffusion_policy = ConfigDict()
    cfg.model.diffusion_policy.d_model = 512
    cfg.model.diffusion_policy.n_heads = 8
    cfg.model.diffusion_policy.denoiser_layers = 10
    cfg.model.diffusion_policy.denoiser_mlp_mult = 4
    cfg.model.diffusion_policy.dropout = 0.0
    cfg.model.diffusion_policy.horizon = 16
    cfg.model.diffusion_policy.num_train_timesteps = 1000
    cfg.model.diffusion_policy.beta_start = 1e-4
    cfg.model.diffusion_policy.beta_end = 2e-2
    cfg.model.diffusion_policy.beta_schedule = "squaredcos_cap_v2"
    cfg.model.diffusion_policy.prediction_type = "v_prediction"
